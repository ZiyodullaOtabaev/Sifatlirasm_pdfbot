...
from bot.keyboards import kb_cancel, kb_top_up, kb_template_gallery, kb_slide_result, kb_author_skip
...
async def cb_ai_slides(call: CallbackQuery, bot: Bot):
    ...
    trial_text = "🎁 <b>Sizda 1 ta BEPUL sinov taqdimoti bor!</b> (0 kredit)" if not used_trial else "📌 Taqdimot narxi: <b>3 kredit</b>"
...
async def cb_select_gallery_template(call: CallbackQuery, bot: Bot):
    ...
    try:
        ...
        cost_notice = "🎁 <b>1-Sinov taqdimotingiz BEPUL berildi!</b>" if cost == 0 else f"💰 Yechildi: <b>3 kredit</b> | Qolgan balans: <b>{remaining} kredit</b>"
